module lp_treasury::LPStorage {
    ...
    public entry fun resolve_liquidity_pact(
        ...
        let current_price_x_in_anchor = amm_oracle::get_average_price(token_x_obj);
        let current_price_y_in_anchor = amm_oracle::get_average_price(token_y_obj);
